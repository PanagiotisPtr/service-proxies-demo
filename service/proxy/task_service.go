...
func (this *TaskService) Create(arg0 context.Context, arg1 *models.Task) error {
	args := []interface{}{
		arg0,
		arg1,
	}
...
func (this *TaskService) Delete(arg0 context.Context, arg1 int64) error {
	args := []interface{}{
		arg0,
		arg1,
	}
...
func (this *TaskService) Get(arg0 context.Context, arg1 int64) (*models.Task, error) {
	args := []interface{}{
		arg0,
		arg1,
	}
...
func (this *TaskService) List(arg0 context.Context) ([]*models.Task, error) {
	args := []interface{}{
		arg0,
	}
...
func (this *TaskService) Update(arg0 context.Context, arg1 *models.Task) error {
	args := []interface{}{
		arg0,
		arg1,
	}
